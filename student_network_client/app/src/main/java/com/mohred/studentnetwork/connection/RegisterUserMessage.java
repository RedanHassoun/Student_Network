...
import static com.mohred.studentnetwork.common.AppConstants.URLs.REGISTER_USER;

/**
 * Created by Redan on 12/16/2016.
 */
public class RegisterUserMessage extends PostMessage
{
    public RegisterUserMessage()
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(REGISTER_USER);
