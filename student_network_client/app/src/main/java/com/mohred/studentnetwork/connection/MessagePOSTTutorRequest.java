...
import static com.mohred.studentnetwork.common.AppConstants.URLs.URL_MAKE_TUTOR_REQUEST;

/**
 * Created by Redan on 2/4/2017.
 */

public class MessagePOSTTutorRequest extends PostMessage
{
    public MessagePOSTTutorRequest()
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(URL_MAKE_TUTOR_REQUEST);
