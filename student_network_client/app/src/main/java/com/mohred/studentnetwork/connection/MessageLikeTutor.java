...
import static com.mohred.studentnetwork.common.AppConstants.URLs.URL_LIKE_TUTOR;

/**
 * Created by Redan on 3/8/2017.
 */

public class MessageLikeTutor  extends  PostMessage
{
    public MessageLikeTutor()
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(URL_LIKE_TUTOR);
