...
public class MultiSpinnerSearch extends Spinner implements DialogInterface.OnCancelListener {
    ...
    private String defaultText = getContext().getString(R.string.select_courses);
    private String spinnerTitle = getContext().getString(R.string.choose_courses_to_tutor);
