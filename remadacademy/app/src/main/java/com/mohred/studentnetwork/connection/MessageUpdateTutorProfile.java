...
import static com.mohred.studentnetwork.common.AppConstants.URLs.URL_UPDATE_TUTOR_PROFILE;

/**
 * Created by Redan on 3/10/2017.
 */

public class MessageUpdateTutorProfile  extends PostMessage
{
    public MessageUpdateTutorProfile()
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(URL_UPDATE_TUTOR_PROFILE);
