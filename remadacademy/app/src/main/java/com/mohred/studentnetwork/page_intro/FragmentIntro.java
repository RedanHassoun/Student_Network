...
public class FragmentIntro extends Fragment
{
    ...
    public static FragmentIntro newInstance(int backgroundColor, int page)
    {
    ...
    {
        MainPage = inflater.inflate(R.layout.activity_intro, container, false);
        ...
        {
            case 0:
                layoutResId = R.layout.app_help_1;
                break;
            case 1:
                layoutResId = R.layout.app_help_2;
                break;
            default:
                layoutResId = R.layout.app_help_3;
        }
