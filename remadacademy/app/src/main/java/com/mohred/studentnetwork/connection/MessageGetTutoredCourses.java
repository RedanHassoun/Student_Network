...
import static com.mohred.studentnetwork.common.AppConstants.URLs.URL_GET_TUTORED_COURSES;

/**
 * Created by Redan on 1/27/2017.
 */
public class MessageGetTutoredCourses extends GetMessage
{
    public MessageGetTutoredCourses(String tutorID,int index)
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(URL_GET_TUTORED_COURSES);
        params.add(tutorID);
        params.add(""+index);
