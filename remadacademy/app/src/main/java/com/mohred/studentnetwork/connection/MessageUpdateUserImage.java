...
import static com.mohred.studentnetwork.common.AppConstants.URLs.URL_UPDATE_USER_IMAGE;

/**
 * Created by Redan on 3/11/2017.
 */

public class MessageUpdateUserImage extends PostMessage
{
    public MessageUpdateUserImage()
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(URL_UPDATE_USER_IMAGE);
