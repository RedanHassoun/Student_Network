...
import static com.mohred.studentnetwork.common.AppConstants.URLs.URL_POST_COURSE_MATERIAL;

/**
 * Created by Redan on 1/14/2017.
 */

public class MessagePostCourseMaterial extends PostMessage
{
    public MessagePostCourseMaterial()
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(URL_POST_COURSE_MATERIAL);
