...
import static com.mohred.studentnetwork.common.AppConstants.URLs.URL_ADD_TUTOR;

/**
 * Created by Redan on 2/4/2017.
 */

public class MessagePOSTTutor extends PostMessage
{
    public MessagePOSTTutor()
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(URL_ADD_TUTOR);
