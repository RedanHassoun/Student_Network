...
import static com.mohred.studentnetwork.common.AppConstants.URLs.URL_UPDATE_TUTPR_REQUEST;

/**
 * Created by Redan on 2/17/2017.
 */
public class MessageUpdateTutorRequest extends PostMessage
{
    public MessageUpdateTutorRequest()
    {
        ArrayList<String> params = new ArrayList<>();
        params.add(URL_UPDATE_TUTPR_REQUEST);
